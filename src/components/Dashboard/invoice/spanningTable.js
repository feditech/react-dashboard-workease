            ...
            <TableRow key={row._id}>
              ...
              <TableCell  sx={{ color: textColor }}  sx={{ color: textColor }} sx={{ color: textColor }}    align="right">{row.amount * row.qty}</TableCell>
                    ...
                    <TableRow>
                        ...
                        <TableCell  sx={{ color: textColor }} sx={{ color: textColor }}     align="right">{invoice.subTotal}</TableCell>
                    </TableRow>
                    <TableRow>
                        ...
                        <TableCell  sx={{ color: textColor }} sx={{ color: textColor }}     align="right">{invoice.VAT}</TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell sx={{ color: textColor }} colSpan={2}>Total</TableCell>
                        <TableCell sx={{ color: textColor }}     align="right">{invoice.total}</TableCell>
                    </TableRow>
                </TableBody>
                    ) : []
                }
